...
$OriginalVersionNumber = $CurrentRelease.name.replace("v", "")
$MajorVersionNumber = [int]$OriginalVersionNumber.split(".")[0]
$NormalVersionNumber = [int]$OriginalVersionNumber.split(".")[1]
$MinorVersionNumber = [int]$OriginalVersionNumber.split(".")[3]
